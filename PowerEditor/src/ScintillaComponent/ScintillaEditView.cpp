...
void ScintillaEditView::performGlobalStyles()
{
	...
	execute(SCI_INDICSETSTYLE, INDICATOR_HISTORY_SAVED_DELETION, INDIC_STRIKE);
	execute(SCI_INDICSETFORE,  INDICATOR_HISTORY_SAVED_DELETION, re2CommittedGreen);
	// Also paint margin markers in matching red/green
	execute(SCI_MARKERSETFORE, SC_MARKNUM_HISTORY_MODIFIED, re2UncommittedRed);
	execute(SCI_MARKERSETBACK, SC_MARKNUM_HISTORY_MODIFIED, re2UncommittedRed);
